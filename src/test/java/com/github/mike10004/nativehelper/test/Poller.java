...
public abstract class Poller<T> {
    ...
    private static final Sleeper SYSTEM_THREAD_SLEEPER = new Sleeper() {
        @Override
    ...
    public static Sleeper getDefaultSleeper() {
        return SYSTEM_THREAD_SLEEPER;
    }

    /**
     * Interface for classes that sleep. A default implementation would use
     * {@link Thread#sleep}. Unit tests may mock this class
